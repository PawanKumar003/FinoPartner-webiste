    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://thefinopartners.com/public/assets/reactimg/bottom-btn-mobile.png')",
          ...
          <div className="w-84 flex justify-around items-center mt-2">
            ...
            <div className="horizontal-shake">
              <a
                ...
                className=" rounded-full px-6 py-1 bg-[#222327] text-xl text-white font-semibold"
              >
                Try Now
              </a>
              <p className="mt-[2px] text-[14px] text-black">
                Limited-time offer!
              </p>
            </div>
          </div>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://thefinopartners.com/public/assets/reactimg/offer-bg.png')",
          backgroundRepeat: "no-repeat",
      ...
      >
        <div className="text-center">
          <p className="text-white">
            Hire An Accountant for CPA Firms & Businesses
          </p>
        ...
        <div className="absolute top-[-20px] left-[50%] transform translate-x-[-50%]">
          <p className="bg-[#FFE891] rounded-full py-1 px-4">
            Limited-time offer!
          </p>
        </div>
      ...
      <section className="w-full px-2 mt-5 bg-[#ECF4FF] py-4">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold">
            Build Your Team in 4 Simple Steps
          </h2>
        </div>
        <div>
          <div className="flex justify-start mt-4">
            ...
            <div className="w-7/5">
              ...
              <p className="text-xs text-[#424242]">
                Schedule a free consultation with our team to understand your
                firm's requirements, workflow, and staffing goals.
              </p>
            </div>
          </div>
          <div className="flex justify-start mt-4">
            ...
            <div className="w-7/5">
              ...
              <p className="text-xs text-[#424242]">
                We’ll share profiles of pre-vetted accountants and tax
                professionals. You can interview and choose the best fit based
                on your needs.
              </p>
            </div>
          </div>
          <div className="flex justify-start mt-4">
            ...
            <div className="w-7/5">
              ...
              <p className="text-xs text-[#424242]">
                We ensure complete data security and transparency by signing a
                mutual NDA and a service agreement outlining roles, KPIs, and
                expectations.
              </p>
            </div>
          </div>
          <div className="flex justify-start mt-4">
            ...
            <div className="w-7/5">
              ...
              <p className="text-xs text-[#424242]">
                Your offshore team is onboarded and starts working seamlessly
                within your existing systems, processes, and time
                zone preferences.
              </p>
            </div>
          </div>
      ...
      <section>
        <div class="w-full max-w-md mx-auto mt-10 px-2">
          <h2 className="text-2xl font-semibold text-center">
            Comprehensive Talent Screening Framework
          </h2>
          <img
            className="w-full h-full"
      ...
      >
        <div className="text-center">
          <p className="text-[#EEBF11] font-semibold text-xl py-2 pb-4">
      ...
      <section className="mt-5 px-4">
        ...
        <div>
          <div className="p-4 flex md:w-full overflow-hidden animate-slide-right bg-transparent">
            ...
            />
            <img
              className="h-full min-w-[2800px]"
              src="https://thefinopartners.com/public/assets/reactimg/Testimonial-img2.png"
              alt=""
            />
          </div>
      ...
      <section className=" text-white mt-15 md:px-10 px-2 bg-[#ECF4FF] py-4">
        <div className="text-center lg:w-1/2 m-auto text-black">
          ...
          <p className="mb-8 md:block hidden">
            ...
            us and we’ll help you with your questions and needs. Get clear
            advice, simple solutions, and friendly support, all in one call.
          </p>
        </div>
        ...
        <div className="w-full max-w-xl mx-auto p-2">
          ...
          <div className=" border-b border-gray-300 rounded-md">
            <details className="group border-b border-gray-200">
              <summary className="flex justify-between items-center cursor-pointer p-4">
                <span className=" font-medium">
                  Why do CPA firms choose offshore staff?
                </span>
                <svg
              ...
              <div className="px-4 pb-4 text-gray-600">
                Offshore staffing gives CPA firms access to experienced
                accountants and tax professionals at a lower cost. It helps
                manage workload spikes, reduce turnaround times, and maintain
                high service quality without increasing internal headcount or
                overhead.
              </div>
            </details>
            ...
            <details className="group border-b border-gray-200">
              <summary className="flex justify-between items-center cursor-pointer p-4">
                <span className=" font-medium">
                  How does offshore staffing help scale a CPA firm?
                </span>
                <svg
                  className="bg-[#D9D9D9] rounded-full w-4 h-4 transition-transform duration-200 group-open:rotate-180"
                  fill="none"
              ...
              <div className="px-4 pb-4 text-gray-600">
                Offshore teams allow firms to expand quickly during tax season
                or peak periods. With flexible, on-demand staffing, CPA firms
                can take on more clients, improve turnaround, and free up senior
            ...
            <details className="group">
              <summary className="flex justify-between items-center cursor-pointer p-4">
                <span className=" font-medium">
                  Can offshore teams boost profit margins?
                </span>
                <svg
                  className="bg-[#D9D9D9] rounded-full w-4 h-4 transition-transform duration-200 group-open:rotate-180"
                  fill="none"
              ...
              <div className="px-4 pb-4 text-gray-600">
                Yes — by lowering staffing costs and improving efficiency,
                offshore solutions help firms increase their margins. Firms can
                grow without the burden of fixed salaries, infrastructure, or
                costly local hiring.
              </div>
            </details>
          </div>
