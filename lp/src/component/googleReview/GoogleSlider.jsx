...
function GoogleSlider({ setIsDialogOpen }) {
  return (
    <section
      className="md:px-10 pt-5 w-full px-5 bg-[#041234] mt-15"
      id="Accountant"
    >
        ...
        <div>
          <div className="text-white">
            ...
            <p className="md:block hidden">
              Access a large team of 250+ expert accountants ready to support
              your business. If you need help with bookkeeping, taxes, payroll,
              or financial advice, we have the right expert for you. Get the
              skills and experience you need without the trouble of hiring
              full-time staff. Expert help, now at your fingertips.
            </p>
            <div className="mt-15 lg:block hidden">
              <a
                onClick={setIsDialogOpen}
                target="_blank"
                className="pulse-animation1 cursor-pointer bg-[#0A6CFF] text-white md:px-20 px-10 py-4 text-xl font-medium rounded-full hover:bg-blue-800"
              >
                Book A Call
              </a>
            </div>
