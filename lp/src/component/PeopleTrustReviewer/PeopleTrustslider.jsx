...
function PeopleTrustslider({ setIsDialogOpen }) {
  return (
    <section
      className=" pt-5 w-full bg-[#ECF4FF] lg:bg-transparent pb-5 scroll-mt-24"
      id="Review"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="bg-[#ECF4FF] md:p-10 p-5">
          <div className="text-black ">
            ...
            <div className="text-center md:mt-15 lg:mt-8 mt-5">
              <a
                className="pulse-animation1 bg-[#0A6CFF] px-5 py-2 text-white rounded-full text-2xl md:text-4xl font-medium cursor-pointer"
